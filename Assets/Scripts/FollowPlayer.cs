...
public class FollowPlayer : MonoBehaviour
{
    ...
    //debug purposes
    [SerializeField]
    private Text debugAgent;

    [SerializeField]
    private Text debugCamPos;

    [SerializeField]
    private Text debugBallPos;
    ...
    void Update()
    {
        Vector3 playerDestination =
            new Vector3(player.position.x, 0f, player.position.z) + offset;
